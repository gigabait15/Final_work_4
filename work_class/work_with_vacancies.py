...
class Work_With_Vacancies:
    ...
    def save_hh(self):
        ...
        for num, value in enumerate(j_open.json_get(1)['items']):
            ...
            if self.__currency in exchange_rates.keys():
                self.__correct_salary = int(self.__correct_salary * exchange_rates[self.__currency])
                self.__currency = "RUR"
            ...
            all_info = {"название вакансии": self.__name, "ссылка на вакансию": self.__link,
                        ...
                        "требуемый опыт": self.__experience, "название компании": self.__employer,
                        "город вакансии": self.__area}
